...
struct ActionButtonLoadingContent: View {
    ...
    init(color: Color = .white, text: String = "") {
        self.color = color
        self.text = text
    }
...
//            .disabled(false)
        ...
        ActionButton(isLoading: false, style: .primary, action: {}, loadingContent: {ActionButtonLoadingContent()}, content: {Text("Button")})
        
        ActionButton(isLoading: false, style: .secondary, action: {}, loadingContent: {ActionButtonLoadingContent()}, content: {Text("Button")})
