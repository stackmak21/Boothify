...
var secondaryButtonColors: ButtonColorSet {
    ButtonColorSet(
        normalBackground: Color.letterGreen,
        normalForeground: Color.white,
        normalBorder: Color.clear,
        pressedBackground:  Color.letterGreen.opacity(0.8),
        pressedForeground: Color.white,
        pressedBorder: Color.clear,
        disabledBackground: Color.gray,
        disabledForeground: Color.white,
